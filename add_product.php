                           ...
                           <form class="form-horizontal" method="POST" action="product_store.php" enctype="multipart/form-data">
                              <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <input type="number" name="productQuantity" class="form-control" placeholder="Enter Product Quantity">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <input type="text" name="productSKU" class="form-control" placeholder="Enter Product SKU">
                                    </div>
                                 </div>
                                 <div class="form-group row">

                           ...
                           <form class="form-horizontal" method="POST" action="product_store.php" enctype="multipart/form-data">
                              <div class="card-body">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <img id="output" alt="Photo" src="images/product.png" width="200px" height="200px">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <input type="number" name="productQuantity" class="form-control" min="1" placeholder="Enter Product Quantity" required>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                       <input type="text" name="productDesc" class="form-control" placeholder="Enter Product Description" required>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Product SKU</label>
                                    <div class="col-sm-10">
                                       <input type="text" name="productSKU" class="form-control" placeholder="Enter Product SKU" required>
                                    </div>
                                 </div>
                                 <div class="form-group row">
                              ...
                              <div class="card-footer">
                                 <button type="submit" class="btn btn-info" name="add_product">Save Changes</button>

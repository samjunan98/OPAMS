    ...
    <div class="card-body login-card-body">
      ...
      <form action="pwcheck_agent.php" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block"  name="agentLogin">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-1">
        <a href="agent_forgetpw.php">I forgot my password</a>
      </p>
      <p class="mb-0">
        <a href="agent_register.php" class="text-center">Register a new account</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>

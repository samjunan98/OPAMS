        ...
        <div class="table-title">
            <form action="" method="GET">
                ...
                <div class="col-sm-auto">
                  <label for="category">Product Search:</label></div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-auto">
                        <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="product_edit.php"><button type="button" class="btn btn-primary">Reset</button></div>
                ...
                <div class="row">
                <div class="col-sm-auto">
                  <label for="category">Product Categories:</label></div>
                    <div class="col-sm-3">
                    <?php
                    include("config.php");
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $row)
                                        {
                                            ...
                                            <tr style="height:200px">
                                                ...
                                                <a href="delete.php?productID=<?php echo $row['productID']; ?>" class="delete" title="Delete"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $row)
                                        {
                                            ...
                                            <tr class="clickable" data-href="productinfo.php?productID=<?php echo $row['productID']; ?>" style="height:100px; cursor:pointer;" >
                                                ...
                                                <a href="deleteprod.php?productID=<?php echo $row['productID']; ?>" class="delete"  title="Delete"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                            <?php
                                        }
                                    }

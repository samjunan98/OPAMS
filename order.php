                                        ...
                                        <div class='col-sm-12 col-md-6 col-lg-4'>
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <button onclick="document.location='order.php'" type="button" title="Refresh" class="btn btn-secondary">
